<template>
	<section class="py-12">
		<div class="container-small px-4">
			...
			<div v-else class="flex flex-col-reverse sm:flex-row gap-y-6 items-center justify-center">
				...
				<div
					...
					:class="{ 'flex items-center justify-center min-h-[200px] text-plaza-dark text-sm italic': !generalInfo?.parkingContent }"
				>
					<div
				...
				<div class="z-0 sm:-ml-6 relative !w-full sm:!w-1/2 lg:!w-2/3 overflow-hidden rounded-[5px_20px_5px_5px] flex-shrink-0 shadow-xl">
