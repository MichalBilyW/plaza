  ...
  <div class="space-y-2">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
      ...
      >
        ...
        />
        <!-- Order badge -->
        <span class="absolute top-1 left-1 w-5 h-5 bg-gray-900/70 text-white text-xs rounded-full flex items-center justify-center">
          {{ index + 1 }}
        </span>
        ...
        <div class="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors rounded-lg flex items-center justify-center">
          <svg class="w-6 h-6 text-white opacity-0 group-hover:opacity-70 transition-opacity drop-shadow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
