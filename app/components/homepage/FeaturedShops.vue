	...
	<section class="py-20 bg-white" :aria-label="t('home.sections.shops')">
		<div class="max-w-7xl sm:px-8 md:mx-auto">
			...
			<div class="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
				...
				<NuxtLink
					to="/obchody"
					class="inline-flex items-center justify-center px-6 py-2 text-center bg-plaza text-white font-sans font-semibold text-base tracking-[0.05em] rounded-[5px_20px_5px_5px] shadow-md hover:shadow-[0_6px_20px_rgba(226,11,27,0.4)] hover:brightness-110 transition-all duration-300"
				>
					{{
						viewMode === 'grid'
