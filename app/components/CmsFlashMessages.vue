        ...
        >
          ...
          >
            ...
            <div :class="['flex-shrink-0', iconClasses[msg.type]]">
              <!-- Success -->
              <svg v-if="msg.type === 'success'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <!-- Error -->
              <svg v-else-if="msg.type === 'error'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <!-- Warning -->
              <svg v-else-if="msg.type === 'warning'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              :class="['flex-shrink-0 p-1 rounded hover:bg-black/10 transition-colors', closeClasses[msg.type]]"
