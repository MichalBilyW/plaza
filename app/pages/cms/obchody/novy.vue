<template>
  <div class="p-4 sm:p-6 lg:p-8">
    <div class="mb-8">
      ...
      <h1 class="text-xl sm:text-2xl font-bold text-gray-900">{{ t('cms.shops.newShop') }}</h1>
    </div>

    <!-- General error -->
    <div v-if="generalError" class="max-w-4xl mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            >
              ...
              >
                {{ unit.id }} - {{ unit.label }}{{ unit.isOccupied ? ` (${unit.shopName})` : '' }}
              </option>
            </select>
