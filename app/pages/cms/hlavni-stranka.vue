		...
		<form v-if="!pending" @submit.prevent="handleSubmit" class="space-y-8 max-w-4xl">
			...
			<div class="bg-white rounded-xl shadow-sm p-6">
				...
				<div class="space-y-6">
					...
					<div v-if="!form.heroImage" class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
						...
						<div class="relative">
							...
							<div class="absolute inset-0 flex items-center justify-center">
								<span class="bg-gray-900/70 text-white text-xs sm:text-sm px-3 py-1 rounded-full">
