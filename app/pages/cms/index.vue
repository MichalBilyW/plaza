    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <div class="bg-white rounded-xl p-6 shadow-sm border-l-4 border-cms-shops-500">
        <div class="flex items-center gap-4">
          <div class="w-12 h-12 bg-cms-shops-100 rounded-lg flex items-center justify-center">
            <svg class="w-6 h-6 text-cms-shops-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="bg-white rounded-xl p-6 shadow-sm border-l-4 border-cms-events-500">
        <div class="flex items-center gap-4">
          <div class="w-12 h-12 bg-cms-events-100 rounded-lg flex items-center justify-center">
            <svg class="w-6 h-6 text-cms-events-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
          </div>
          <div>
            <p class="text-2xl font-bold text-cms-events-700">{{ stats?.events || 0 }}</p>
      ...
      <div class="bg-white rounded-xl p-6 shadow-sm border-l-4 border-cms-services-500">
        <div class="flex items-center gap-4">
          <div class="w-12 h-12 bg-cms-services-100 rounded-lg flex items-center justify-center">
            <svg class="w-6 h-6 text-cms-services-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </div>
          <div>
            <p class="text-2xl font-bold text-cms-services-700">{{ stats?.services || 0 }}</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white rounded-xl p-6 shadow-sm">
        ...
        <div class="space-y-2">
          ...
          >
            <svg class="w-5 h-5 text-cms-shops-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
            </svg>
            <span class="group-hover:text-cms-shops-700">{{ $t('cms.dashboard.addShop') }}</span>
          </NuxtLink>
          <NuxtLink
            to="/cms/akce/nova"
          ...
          >
            <svg class="w-5 h-5 text-cms-events-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
            </svg>
            <span class="group-hover:text-cms-events-700">{{ $t('cms.dashboard.addEvent') }}</span>
          </NuxtLink>
          <NuxtLink
            to="/cms/sluzby/nova"
          ...
          >
            <svg class="w-5 h-5 text-cms-services-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
            </svg>
            <span class="group-hover:text-cms-services-700">{{ $t('cms.dashboard.addService') }}</span>
          </NuxtLink>
        </div>
      </div>

      <div class="bg-white rounded-xl p-6 shadow-sm">
        <h2 class="text-cms-events-500 text-lg font-semibold mb-4">{{ $t('cms.dashboard.upcomingEvents', { count: upcomingEvents.length }) }}</h2>
