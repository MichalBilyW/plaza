<template>
  <div class="p-4 sm:p-6 lg:p-8">
    <div class="mb-8">
      <h1 class="text-xl sm:text-2xl font-bold text-gray-900">{{ t('cms.generalInfo.title') }}</h1>
    ...
    <form v-if="!pending" @submit.prevent="handleSubmit" class="space-y-8 max-w-4xl">
      ...
      <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            />
            <p class="mt-1 text-xs text-gray-500">{{ form.shortText?.length || 0 }}/500</p>
          </div>

          <!-- Text -->
          <div>
            <label for="text" class="block text-sm font-medium text-gray-700 mb-1">
              {{ t('cms.generalInfo.text') }}
            </label>
            <textarea
              id="text"
              v-model="form.text"
              ...
              maxlength="10000"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-plaza-500 focus:border-transparent"
              :placeholder="t('cms.generalInfo.textPlaceholder')"
            />
            <p class="mt-1 text-xs text-gray-500">{{ form.text?.length || 0 }}/10000</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-lg font-semibold text-gray-700 border-b border-gray-100 pb-2 flex-1">
