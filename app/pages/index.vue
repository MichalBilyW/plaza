			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div class="flex items-center gap-4">
						<div
							class="w-12 h-12 bg-plaza-100 rounded-lg flex items-center justify-center"
						>
							<svg
								class="w-6 h-6 text-plaza-600"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 24 24"
							>
						...
						<div>
							...
							<p class="text-gray-600">
								{{ $t('home.quickInfo.openingHoursValue') }}
							</p>
						</div>
					</div>
			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					<div
						v-for="i in 3"
						:key="i"
						class="bg-white rounded-xl overflow-hidden animate-pulse"
					>
				...
				<div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					...
					>
						<div class="h-48 bg-plaza-100 flex items-center justify-center">
							...
							<svg
								v-else
								class="w-16 h-16 text-plaza-300"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 24 24"
							>
